...
namespace Gestion_RecursoHumano
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, GestionContext>();
            ...
            container.RegisterType<ILicenciaRepository, LicenciaRepository>();
            container.RegisterType<INominaRepository, NominaRepository>();
            container.RegisterType<IPermisoRepository, PermisoRepository>();
            container.RegisterType<ISalida_EmpleadoRepository, Salida_EmpleadoRepository>();
            container.RegisterType<IVacacionRepository, VacacionRepository>();
        }
    }
}